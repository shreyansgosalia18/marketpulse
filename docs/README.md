...
### Aggregation Service
- User stories: [user-stories/aggregation-trend-computation.md](user-stories/aggregation-trend-computation.md), [user-stories/postgres-persistence-layer.md](user-stories/postgres-persistence-layer.md), [user-stories/redis-caching-layer.md](user-stories/redis-caching-layer.md), [user-stories/rest-api.md](user-stories/rest-api.md)
